...
import { getLovs, lovMap, updateStatus } from '@/services/cms-app/api';
import { getCardContext } from '@/services/cms-app/session';
    ...
    <PageShell title="Change status" subtitle="Freeze, block or activate" back>
      ...
      <form className="panel form-stack" onSubmit={onSubmit}>
        ...
        <Field label="New status">
          <select value={statusCode} onChange={(e) => setStatusCode(e.target.value)} required>
